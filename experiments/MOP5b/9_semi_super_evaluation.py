...
def main():
    ...
    flag_cat_cell_type = "rev_ind" in res_adata.obs.columns
    if flag_cat_cell_type:
        rev_ind = res_adata.obs["rev_ind"].values
        target = mdata.obs[label_name].values[rev_ind]
        batch = mdata.obs[batch_name].values[rev_ind]
    else:
    ...
    # plot umap
    # ========================================================================
    print("========== plot umap of mmAAVI-semi ==========")
    ...
    if "rev_ind" in res_adata.obs.columns:
        rev_ind = res_adata.obs["rev_ind"].values
