...
def run(
    ...
    if isinstance(dat, str):
        ...
        raise ValueError(
            "fat must be MosaicData or the file name of MosaicData"
        )
...
cfg = SimpleNamespace(
    ...
    model_common={
        ...
        "distributions": {"atac": "nb", "rna": "nb", "met": "ziln"},
        "distributions_style": "batch",
        # "hiddens_disc": None,
        "hiddens_enc_c": [50],  # [100, 100],
        "hiddens_enc_u": [50],  # [100, 100],
        "hiddens_prior": [],
    },
    model_2=dict(
        disc_bn=True,
...
for nc in range(14, 20):  # range(8, 19):
    print("nc = %d" % nc)
    cfg_cp = deepcopy(cfg)
    ...
    run(
        ...
        dat=data_fn,
        save_root=res_dir,
        trial_prefix="cdimension_graph_feats_%d_" % nc,
        seeds=range(6),
    )
